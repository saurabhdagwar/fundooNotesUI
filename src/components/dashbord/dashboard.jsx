            ...
            <div className="buttonContainer">
              ...
              <div className="button">
                ...
                >
                  ...
                  <MenuItem onClick={settingHandleClose}>Enable dark Theam</MenuItem>
                  <MenuItem onClick={settingHandleClose}>Send Feedback</MenuItem>
                  <MenuItem onClick={settingHandleClose}>Help</MenuItem>
                  <MenuItem onClick={settingHandleClose}>App Downloads</MenuItem>
                  <MenuItem onClick={settingHandleClose}>Keyboard shortcuts</MenuItem>
                </Menu>
                </Paper>
                 </div>
            </div>
        ...
        <div className="drawerList">
          <List>
            <div  className="drawerButton" onClick={notesSelect}>
              <ListItem button className="drawerListButton" className={classes.drawerButton} style={{ backgroundColor: notes ? "#ffe0b2" : "transparent"}}>
                <ListItemIcon >
                  <svg
                    width="28"
                    height="28"
            ...
            <div className="drawerButton" onClick={reminderSelect}>
              <ListItem button className="drawerListButton" className={classes.drawerButton} style={{ backgroundColor: reminders ? "#ffe0b2" : "transparent"}}>
                <ListItemIcon>
                  <svg
                    width="28"
                    height="28"
            ...
            <div className="drawerButton" onClick={editLabelSelect}>
              <ListItem button className="drawerListButton" className={classes.drawerButton} style={{ backgroundColor: editLabels ? "#ffe0b2" : "transparent"}}>
                <ListItemIcon>
                  <svg
                    width="28"
                    height="28"
            ...
            <div className="drawerButton" onClick={achiveSelect}>
              <ListItem button className="drawerListButton" className={classes.drawerButton} style={{ backgroundColor: achive ? "#ffe0b2" : "transparent"}}>
                <ListItemIcon>
                  <svg
                    width="28"
                    height="28"
            ...
            <div className="drawerButton" onClick={trashSelect}>
              <ListItem button className="drawerListButton" className={classes.drawerButton} style={{ backgroundColor: trash ? "#ffe0b2" : "transparent"}}>
                <ListItemIcon>
                  <svg
                    width="28"
                    height="28"
